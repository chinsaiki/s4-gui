...
class L2Instrument_tableMarket: public QWidget
{
    Q_OBJECT
public:
    L2Instrument_tableMarket(int snapLeves_nb,QWidget *parent = nullptr);

    void mouseMoveEvent(QMouseEvent* )
    {
        //qDebug() << "L2Instrument_tableMarket " << hasMouseTracking() << " " << event->pos().x() << ", " << event->pos().y();
    }
